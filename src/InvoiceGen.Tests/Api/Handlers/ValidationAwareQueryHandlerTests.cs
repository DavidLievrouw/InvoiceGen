...
namespace DavidLievrouw.InvoiceGen.Api.Handlers {
  ...
  public class ValidationAwareQueryHandlerTests {
    ...
    public void ConstructorTests() {
      Assert.Throws<ArgumentNullException>(() => new ValidationAwareQueryHandler<object, object>(null, A.Dummy<IQueryHandler<object, object>>()));
      Assert.Throws<ArgumentNullException>(() => new ValidationAwareQueryHandler<object, object>(A.Dummy<IValidator<object>>(), null));
    }
